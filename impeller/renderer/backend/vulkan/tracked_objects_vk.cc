...
void TrackedObjectsVK::Track(const std::shared_ptr<const DeviceBuffer>& buffer) {
...
void TrackedObjectsVK::Track(const std::shared_ptr<const TextureSourceVK>& texture) {
